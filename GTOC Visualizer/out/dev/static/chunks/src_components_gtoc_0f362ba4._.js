 ...
 * ------------------------------------------------------------------------------------------
 * Uses a fixed-step 4th-order Runge-Kutta integrator (Cowell formulation)
 * for two-body trajectory propagation. Designed for use in GTOC visualizations.
 */ __turbopack_context__.s([
    "MU_ALTAIRA",
    ()=>MU_ALTAIRA,
    "propagateArcCowell",
...
const MU_ALTAIRA = 139_348_062_043.343; // km^3 / s^2
/* =============================================================
   🔹 Vector & Dynamics Utilities
============================================================= */ /** Euclidean norm */ function norm(v) {
    return Math.sqrt(v.reduce((acc, val)=>acc + val * val, 0));
}
/** Two-body gravitational dynamics under central body */ function twoBodyDynamics(t, state, mu) {
    ...
    const rNorm = norm(rVec);
    const ax = -mu * rx / Math.pow(rNorm, 3);
    const ay = -mu * ry / Math.pow(rNorm, 3);
    const az = -mu * rz / Math.pow(rNorm, 3);
    return [
        vx,
        vy,
        vz,
...
function propagateArcCowell(r0, v0, dt, mu = MU_ALTAIRA, samples = 40) {
    const y0 = [
        ...r0,
        ...v0
    ];
    ...
    let state = y0;
    let t = 0;
    const step = dt / samples;
    for(let i = 0; i < samples; i++){
        results.push({
            t,
            state
        });
        state = rk4Step(twoBodyDynamics, t, state, step, mu);
        t += step;
    }
    return results;
} /* =============================================================
...
============================================================= */  /*
import { propagateArcCowell, MU_ALTAIRA } from "./arc_trajectories_cowells_method";

const r0 = [7000, 0, 0];        // km
const v0 = [0, 7.546, 1.0];     // km/s
const dt = 86400;                // 1 day
const samples = 100;

const result = propagateArcCowell(r0, v0, dt, MU_ALTAIRA, samples);
console.log(result);
*/ 
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$utils$2f$arc_trajectories_cowells_method$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/gtoc/utils/arc_trajectories_cowells_method.tsx [app-client] (ecmascript)"); // ✅ import your Cowell integrator
...
const useSolutions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        /* =============================================================
   🛰️ Import and propagate a new solution file
  ============================================================= */ importSolution: async (file)=>{
            try {
                const text = await file.text();
                const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$solutions$2f$parseSolutionFile$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseSolutionFile"])(text);
                console.log(`[useSolutions] Imported ${parsed.name} with ${parsed.samples.length} samples`);
                const propagatedSamples = [];
                // 🔄 Loop through each pair of samples to identify arcs
                for(let i = 0; i < parsed.samples.length - 1; i++){
                    ...
                    if (isArc && dt > 1.0) {
                        ...
                        const v0 = s0.v;
                        try {
                            // ⚙️ Numerically integrate this arc using Cowell’s method
                            const sol = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$utils$2f$arc_trajectories_cowells_method$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["propagateArc"])(r0, v0, dt, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ALTAIRA_GM"], 40);
                            sol.forEach(({ t, state })=>{
                            ...
                            // Fallback — append original sample if propagation fails
                ...
                // ✅ Update the parsed solution with propagated data
...
;
;
/* ---------- Rotation Matrix ---------- */ function pqwToIJK(Ω, i, ω) {
...
/* ---------- Kepler Solver ---------- */ function solveE(M, e) {
...
function BodyPoint({ body, jd, showLabel = false }) {
    ...
    /* ---------- Orbit path (for hover only) ---------- */ const orbitGeom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BodyPoint.useMemo[orbitGeom]": ()=>{
            ...
            for(let k = 0; k <= segments; k++){
                ...
                const v = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"](r * cosν, r * sinν, 0).applyMatrix3(R);
                pts.push(v);
            }
    ...
    /* ---------- Position update ---------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$f8cd670d$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"])({
        "BodyPoint.useFrame": ()=>{
            ...
            const pos = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"](r * cosν, r * sinν, 0).applyMatrix3(R);
                    ...
                    showLabel && body.type === "Planet" || isSelected ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$web$2f$Html$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Html"], {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            style: {
                                ...
                                background: isSelected ? "rgba(0,0,0,0.4)" : "rgba(0,0,0,0.25)",
...
_s(useSimClock, "bcyvPhEZvpyHVoOMPVYaV2fukYo=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function ViewerCanvas(props = {}) {
    ...
    const tooltip = hover && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=src_components_gtoc_0f362ba4._.js.map