...
function MovieOverlay() {
    _s1();
    const { isMovieMode, isPresentationMode, logos, addLogo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$stores$2f$useMovieStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMovieStore"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            !isPresentationMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(MovieOverlay, "f7Grmmcd3jWgu3PyS4MouD1+0OM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$stores$2f$useMovieStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMovieStore"]
    ];
});
...
class VideoRecorder {
    ...
    async startRecording(manualFrame = false, fps = 60) {
        if (!this.isSupported()) throw new Error("MediaRecorder API not supported");
        this.chunks = [];
        // Create stream (0 fps for manual, or requested fps for automatic)
        // If manual, we use 0 to stop auto-capture.
        this.stream = this.canvas.captureStream(manualFrame ? 0 : fps);
        // Max bitrate for high quality (e.g. 50Mbps)
        const options = {
            mimeType: this.getSupportedMimeType(),
            videoBitsPerSecond: 100 * 1000 * 1000 // 100 Mbps for 4K
        };
        try {
            this.mediaRecorder = new MediaRecorder(this.stream, options);
        } catch (e) {
            console.warn("Failed to create MediaRecorder with ideal options, trying fallback", e);
            // Try fallback options (lower bitrate or default codec)
            try {
                this.mediaRecorder = new MediaRecorder(this.stream, {
                    videoBitsPerSecond: 25 * 1000 * 1000 // 25 Mbps fallback
                });
            } catch (e2) {
                console.warn("Fallback failed, using defaults (Low Quality warning)", e2);
                alert("Warning: Could not configure High Quality recording. Falling back to browser default (resolution might be poor).");
                this.mediaRecorder = new MediaRecorder(this.stream);
            }
        }
        ...
        console.log("Recorder started", manualFrame ? "(Manual Mode)" : "(Auto Mode)");
    }
    captureFrame() {
        if (this.stream) {
            const track = this.stream.getVideoTracks()[0];
            // @ts-ignore - requestFrame is standard in CanvasCaptureMediaStreamTrack but TS might miss it
            if (track.requestFrame) {
                // @ts-ignore
                track.requestFrame();
            } else {
                // Fallback: This might rely on auto-capture if requestFrame is missing (unlikely in Chrome)
                console.warn("requestFrame not supported on track");
            }
        }
    }
    stopRecordingAndDownload(filename = "gtoc_movie.webm") {
        return new Promise((resolve)=>{
            if (!this.mediaRecorder) return resolve();
            // Safety timeout: If browser doesn't fire onstop within 3s, force resolve to unblock UI
            const safetyTimer = setTimeout(()=>{
                console.warn("MediaRecorder onstop timeout - forcing cleanup");
                resolve();
            }, 3000);
            this.mediaRecorder.onstop = ()=>{
                ...
                console.log("Recorder stopped, saved", finalFilename);
                resolve();
            };
...
function ViewerCanvas(props = {}) {
    ...
    const { isRecording, isMovieMode, aspectRatio, isPresentationMode } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$stores$2f$useMovieStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMovieStore"])();
    const handleMakeMovie = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ViewerCanvas.useCallback[handleMakeMovie]": async ()=>{
            // IMPORTANT: read current store value at click-time (avoid stale closures)
            ...
            const recordingNow = store.isRecording;
            // We only need the canvas for recording. glRef can be null depending on timing.
            if (!canvasRef.current) return;
            // -------------------- STOP --------------------
            if (recordingNow) {
                // Flip flag FIRST so the deterministic loop breaks immediately
                store.setRecording(false, 0);
                store.setRecordingProgress(0);
                try {
                    // Best effort stop; may throw if recorder not fully started
                    await recorderRef.current?.stopRecordingAndDownload(`vectra_movie_${Date.now()}`);
                } catch (e) {
                    console.error("Stop recording failed", e);
                } finally{
                    setPlaying(false);
                    // Restore layout back to normal
                    window.dispatchEvent(new Event("resize"));
                }
                return;
            }
            // -------------------- START --------------------
            // Set recording true first so layout switches to 4K container
            store.setRecording(true, 0);
            // Force layout + R3F resize to the new container size (4K)
            window.dispatchEvent(new Event("resize"));
            // Give React + R3F a couple frames to commit the new canvas backing size
            await new Promise({
                "ViewerCanvas.useCallback[handleMakeMovie]": (r)=>requestAnimationFrame({
                        "ViewerCanvas.useCallback[handleMakeMovie]": ()=>requestAnimationFrame(r)
            ...
            // Always create a new recorder instance bound to the current canvas
            recorderRef.current = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$utils$2f$VideoRecorder$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VideoRecorder"](canvasRef.current);
            // Reset Simulation to a deterministic baseline
            setPlaying(false);
            // Determine Range from Keyframes or Default
            ...
            const endJD = keys.length > 0 ? keys[keys.length - 1].jd : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JD_EPOCH_0"] + 60; // Default 60 days
            // FPS config
            const FPS = 23;
            // rate is DAYS / SECOND, FPS is FRAMES / SECOND
            // dtPerFrame is DAYS / FRAME
            const dtPerFrame = (rate || 50) / FPS;
            // Correct frames math: JD deltas are already in DAYS
            const totalFrames = Math.max(1, Math.ceil((endJD - startJD) / dtPerFrame));
            // Jump to start frame
            setJD(startJD);
            // Let scene settle a bit
            await new Promise({
                "ViewerCanvas.useCallback[handleMakeMovie]": (r)=>setTimeout(r, 250)
            }["ViewerCanvas.useCallback[handleMakeMovie]"]);
            try {
                // Optional sanity check (helps diagnose "never starts" issues)
                const stream = canvasRef.current.captureStream?.(FPS);
                if (!stream) throw new Error("captureStream() not available on this canvas/browser.");
                await recorderRef.current.startRecording(true, FPS); // Manual mode
                setPlaying(false); // Ensure clock is manual
                // Deterministic render loop: step JD -> wait for 2 RAF -> capture
                for(let i = 0; i <= totalFrames; i++){
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$stores$2f$useMovieStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMovieStore"].getState().setRecordingProgress(i / totalFrames);
                }
                // If user stopped early, don't force "success"
                if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$stores$2f$useMovieStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMovieStore"].getState().isRecording) {
                    await recorderRef.current.stopRecordingAndDownload(`vectra_movie_${Date.now()}`);
                    alert("Video generated successfully! Check your downloads.");
                }
            } catch (e) {
                console.error("Recording failed", e);
                alert("Recording Failed: " + (e instanceof Error ? e.message : String(e)));
            } finally{
                // Always clean state
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$stores$2f$useMovieStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMovieStore"].getState().setRecording(false, 0);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gtoc$2f$stores$2f$useMovieStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMovieStore"].getState().setRecordingProgress(0);
                setPlaying(false);
                window.dispatchEvent(new Event("resize"));
            }
        }
    ...
    const videoLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ViewerCanvas.useMemo[videoLayout]": ()=>{
            ...
            // Recording override: actual 4K surface scaled down for preview
            if (isRecording) {
                const realW = 3840;
                const realH = 2160;
                const scale = Math.min(w / realW, h / realH);
                return {
                    w: realW,
                    h: realH,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                style: isMovieMode && videoLayout && !isPresentationMode ? {
                    width: videoLayout.w,
                ...
                children: [
                    !isMovieMode && !isPresentationMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$react$2d$three$2d$fiber$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Canvas"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("group", {
                                ...
                                onClick: (e)=>e.stopPropagation(),
                                children: !isPresentationMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$core$2f$GizmoHelper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GizmoHelper"], {
                    ...
                    !isPresentationMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PortalHUD, {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s3(ViewerCanvas, "H0HSxoVLD2zqWeSMJeycEPxXbzc=", false, function() {
    return [
...
//# sourceMappingURL=src_components_gtoc_e9ba1ee9._.js.map